...
namespace KineMartAPI.Migrations
{
    ...
    [Migration("20240220060750_DbUpdated_8")]
    partial class DbUpdated_8
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KineMartAPI.ModelEntities.RefreshToken", b =>
                {
                    b.Property<int>("RefreshId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("re_token_id");
            ...
            modelBuilder.Entity("KineMartAPI.ModelEntities.Export", b =>
                {
                    b.HasOne("KineMartAPI.ModelEntities.ApplicationUser", "ApplicationUser")
                        .WithMany()
